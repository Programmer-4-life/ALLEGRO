		      ...
		      <div className="col-lg-8">
		        <div className="single-blog-inner">
		          ...
		          <div className="details">
		            ...
		            <ul className="meta-inner">
		              ...
		              <li><img src={publicUrl+"assets/img/icon/2.png"} alt="img" /> Marce 9 , 2023</li>
		              <li><img src={publicUrl+"assets/img/icon/3.png"} alt="img" /> Marce 9 , 2023</li>
		            </ul>
		        ...
		        <div className="single-blog-inner">
		          ...
		          <div className="details">
		            ...
		            <ul className="meta-inner">
		              <li><img src={publicUrl+"assets/img/icon/1.png"} alt="img" /> By Admin</li>
		              <li><img src={publicUrl+"assets/img/icon/2.png"} alt="img" /> May 9 , 2022</li>
		              <li><img src={publicUrl+"assets/img/icon/3.png"} alt="img" /> May 9 , 2022</li>
		            </ul>
		            <p>Lorem ipsum dolor sit amet, Lorem ipsum dolor sit amet, consectetur et adipisicing  eiLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor</p>
		            <div className="row">
		              <div className="col-7">
		        ...
		        <div className="single-blog-inner">
		          <div className="details">
		            ...
		            <ul className="meta-inner">
		              <li><img src={publicUrl+"assets/img/icon/1.png"} alt="img" /> By Admin</li>
		              <li><img src={publicUrl+"assets/img/icon/2.png"} alt="img" /> Dec 1 , 2019</li>
		              <li><img src={publicUrl+"assets/img/icon/3.png"} alt="img" /> Dec 1 , 2019</li>
		            </ul>
		          </div>        
		        </div>
		        <div className="single-blog-inner style-quote text-center" style={{background: 'url('+publicUrl+'assets/img/blog/4.png)'}}>
		          <div className="details">
		            ...
		            <ul className="meta-inner">
		              ...
		              <li><img src={publicUrl+"assets/img/icon/5.png"} alt="img" /> Jan 23 , 2022</li>
		              <li><img src={publicUrl+"assets/img/icon/6.png"} alt="img" /> Jan 23 , 2022</li>
		            </ul>
		          </div>        
		        </div>
		        <div className="single-blog-inner">
		          <div className="details">
		            ...
		            <ul className="meta-inner">
		              <li><img src={publicUrl+"assets/img/icon/1.png"} alt="img" /> By Admin</li>
		              <li><img src={publicUrl+"assets/img/icon/2.png"} alt="img" /> Nov 27 , 2021</li>
		              <li><img src={publicUrl+"assets/img/icon/3.png"} alt="img" /> Nov 27 , 2021</li>
		            </ul>
		            <p>Lorem ipsum dolor sit amet, Lorem ipsum dolor sit amet, consectetur et adipisicing  eiLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor</p>
		            <div className="row">
		              <div className="col-7">
