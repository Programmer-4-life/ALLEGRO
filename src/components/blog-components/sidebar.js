            ...
            <aside className="sidebar-area">
              ...
              <div className="widget widget-news">
                ...
                <div className="single-news-wrap media">
                  ...
                  <div className="media-body align-self-center">
                    <h6><Link to="/blog-details">Responsive Web And Desktop Developer</Link></h6>
                    <p className="date"><i className="far fa-calendar-alt" />17 May 2023</p>
                  </div>
                </div>
                <div className="single-news-wrap media">
                  <div className="thumb">
                  ...
                  <div className="media-body align-self-center">
                    <h6><Link to="/blog-details">Admin is MERN Developer</Link></h6>
                    <p className="date"><i className="far fa-calendar-alt" />25 Aug 2020</p>
                  </div>
                </div>
              </div>
