			            ...
			            <div className="single-product-wrap style-2">
			                ...
			                <div className="product-wrap-details">
			                  <div className="media">
			                    ...
			                    <div className="media-body">
			                      ...
			                      <p><img src={publicUrl+"assets/img/icon/location-alt.png"} alt="img" />Bahria Town real estate </p>
			                    </div>
			              ...
			              <div className="product-details-inner">
			                ...
			                <ul className="meta-inner">
			                  <li><img src={publicUrl+"assets/img/icon/location2.png"} alt="img" />Bahria Town</li>
			                  <li><Link to="/property-details">For Sell</Link></li>
			                </ul>
			                <p>Lorem ipsum dolor  constetur </p>
			                <span className="price">Rs 80,650.00</span>
			              </div>
			        ...
			        <aside className="sidebar-area">
			          ...
			          <div className="widget widget-place">
			            ...
			            <ul>
			              ...
			              <li>Park Facing <span>20</span></li>
