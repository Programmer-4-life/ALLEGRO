			      ...
			      <div className="property-details-top-inner">
			        <div className="row">
			          <div className="col-lg-7">
			            ...
			            <p><img src={publicUrl+"assets/img/icon/location2.png"} alt="img" /> Bahria Town 261, Sam Road, Right Side real estate </p>
			            <ul>
			              <li>3 Bedroom</li>
			              <li>Bathroom</li>
			              <li>1026 sqft</li>
			          ...
			          <div className="col-lg-5 text-lg-right">
			            ...
			            <ul>
			              <li><img src={publicUrl+"assets/img/icon/1.png"} alt="img" />March 9 , 2020</li>
			        ...
			        <div className="single-property-details-inner">
			          ...
			          <div className="single-property-grid">
			            ...
			            <div className="property-video text-center" style={{background: 'url('+publicUrl+'assets/img/project-single/8.png)'}}>
			              <a className="play-btn" href="https://www.youtube.com/watch?v=y9j-BL5ocW8" data-effect="mfp-zoom-in"><i className="fa fa-play" aria-hidden="true" /></a>
			            </div>
			          </div>
			          <div className="single-property-grid">
			            <h4>Whats Nearby?</h4>
			      ...
			      <div className="col-lg-4">
			        <aside className="sidebar-area">
			          ...
			          <div className="widget widget-place">
			            ...
			            <ul>
			              <li>Bahria Town <span>26</span></li>
