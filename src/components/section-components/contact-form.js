                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <div className="contact-single-list">
                            ...
                            <ul>
                              <li><img src={publicUrl+"assets/img/icon/location2.png"} alt="img" /> Street 16 Malir Cantonment, Karachi</li>
                              <li><img src={publicUrl+"assets/img/icon/location2.png"} alt="img" /> +(92) 334 1106810</li>
                              <li><img src={publicUrl+"assets/img/icon/location2.png"} alt="img" /> +(92) 334 1106810</li>
                            </ul>
                          </div>
                        </div>
